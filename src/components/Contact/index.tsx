...
export default function Contact() {
    return (
        <section id="contact" className="h-dvh w-full">
            <div className="absolute h-full w-full">
                ...
                <div className="absolute top-1/2 left-1/2 flex max-w-150 -translate-x-1/2 -translate-y-1/2 transform flex-col items-center justify-center space-y-6 text-black">
                    <h2 className="font-bodoni flex scroll-m-20 flex-col justify-center pb-2 text-left text-5xl 2xl:text-7xl font-semibold tracking-tight first:mt-0">
                    ...
                    <p className="font-red-rose flex flex-col text-center text-lg 2xl:text-xl">
                        ...
                        saepe recusandae cum, facilis dolorum, aut exercitationem sed autem totam
                        libero nam labore rem culpa. Iste vitae voluptatem iusto aperiam!
                    </p>
